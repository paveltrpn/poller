...
bool ResetEvent::awaiter::await_ready() const noexcept {
    return m_event.is_set();
}

bool ResetEvent::awaiter::await_suspend(
...
ResetEvent::ResetEvent( bool initiallySet ) noexcept
    : m_state( initiallySet ? this : nullptr ) {
}

bool ResetEvent::is_set() const noexcept {
    return m_state.load( std::memory_order_acquire ) == this;
}

void ResetEvent::reset() noexcept {
    void* oldValue = this;
    m_state.compare_exchange_strong( oldValue, nullptr,
                                     std::memory_order_acquire );
}

void ResetEvent::set() noexcept {
...
ResetEvent::awaiter ResetEvent::operator co_await() const noexcept {
    return awaiter{ *this };
}
